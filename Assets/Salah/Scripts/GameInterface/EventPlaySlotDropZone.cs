...
public class EventPlaySlotDropZone : DropZone
{
    protected override bool CanAccept(CardData data) => data is EventCardData;
    ...
    protected override void Accept(CardViewUI cardUI, DraggableCard draggable)
    {
        ...
        if (card?.cardData is EventCardData ec)
            Player.instance.eventCardDeck.Remove(ec);
